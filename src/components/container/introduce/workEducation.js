...
function WordEducation() {
    ...
    return (
            <div className={clsx(styles.view)}>
                ...
                <div className={styles.view_matop}>
                    <h2 className={styles.view_content}>Đại học</h2>
                    <div className={styles.view_addJob}>
                        <i className="fa-solid fa-plus"></i>
                        <p>Thêm trường Cao Đẳng/ Đại học</p>
                    </div>
                    <ul className={styles.view_list}>
                        <li className={styles.view_item}>
                            <div className={styles.view_avatar}>
                ...
                <div className={styles.view_matop}>
                    <h2 className={styles.view_content}>Trường trung học</h2>
                    <div className={styles.view_addJob}>
                        <i className="fa-solid fa-plus"></i>
                        <p>Thêm trường trung học</p>
                    </div>
                    <ul className={styles.view_list}>
                        <li className={styles.view_item}>
                            <div className={styles.view_avatar}>
...
export default memo(WordEducation)